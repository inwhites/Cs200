...
#include "SensorConfig_OV7670.h"
#include "LCD.h"

#define VSYNC_GPIO_PIN           GPIO_Pin_12
#define VSYNC_GPIO_PORT          GPIOB
#define VSYNC_CLK                RCC_AHB1Periph_GPIOB

#define VSYNC_EXTI_LINE          EXTI_Line12
#define VSYNC_EXTI_PORT_SOURCE   EXTI_PortSourceGPIOB
#define VSYNC_EXTI_PIN_SOURCE    EXTI_PinSource12
